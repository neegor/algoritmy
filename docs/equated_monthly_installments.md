...
Равноценный ежемесячный платёж (__EMI__) — это фиксированная сумма, которую заёмщик выплачивает кредитору в определённый день каждого месяца. Ежемесячные платежи используются для погашения как процентов, так и основной суммы долга, что позволяет полностью погасить кредит в течение определённого периода времени.

Как и в случае с большинством видов кредитов, таких как ипотека на недвижимость, заёмщик выплачивает кредитору фиксированные периодические платежи в течение нескольких лет. __EMI__ отличается от планов с переменными платежами, в которых заёмщик может вносить более высокие суммы по своему усмотрению. В планах __EMI__ заёмщикам обычно разрешается вносить только одну фиксированную сумму в месяц.
