# Скачивание картинок из поиска Google
...
def download_images_from_google_query(query: str = "imagess", max_images: int = 5) -> int:
    # (1)!
...
1.  Осуществляет поиск в Google по заданному запросу и загружает найденные изображения в нужную папку.

    __query__: Поисковый запрос по изображению. По умолчанию "images".
    __image_numbers__: По умолчанию 5.

    __Returns__: Количество успешно загруженных изображений.
